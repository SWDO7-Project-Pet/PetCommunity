	...
	<div id="wrapper">
		...
		<ul
			...
			<li class="nav-item active"><a class="nav-link" href="#"> <i
					class="fas fa-fw fa-tachometer-alt"></i> <span>대쉬보드</span></a></li>
			...
			<li class="nav-item"><a class="nav-link collapsed" href="#"
				...
				<div id="collapseTwo" class="collapse" aria-labelledby="headingTwo"
					...
					<div class="bg-white py-2 collapse-inner rounded">
						...
						<a class="collapse-item" href="/freeBoard/freeBoardMain">자유
							게시판</a> <a class="collapse-item" href="#">사진 게시판</a>
					</div>
				</div></li>
			...
			<li class="nav-item"><a class="nav-link collapsed" href="#"
				...
				aria-expanded="true" aria-controls="collapseUtilities"> <i
					class="fas fa-fw fa-wrench"></i> <span>정보</span>
			</a>
			...
			<li class="nav-item"><a class="nav-link" href="#"> <i
					class="fas fa-fw fa-chart-area"></i> <span>거래 게시판</span></a></li>

			<!-- Nav Item - Tables(2번째의 2 탭) -->
			<li class="nav-item"><a class="nav-link" href="#"> <i
					class="fas fa-fw fa-table"></i> <span>넣을거 추천점</span></a></li>
